...
from .views import UserRegistrationView, ParticipantScoresAPIView, ParticipantsScoresAPIView, SetScoreView, GetCriterios, GetPart, ParticipantsAdd, GetUserInfo
